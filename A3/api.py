...
def homepage():
    ...
    conn.execute('CREATE TABLE USERS (USERNAME LONGTEXT PRIMARY KEY, PASSWORD LONGTEXT NOT NULL)')
    conn.execute('CREATE TABLE CATEGORY (CATEGORYNAME LONGTEXT PRIMARY KEY)')
